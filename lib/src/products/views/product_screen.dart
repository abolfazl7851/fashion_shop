...
import 'package:fashion/src/cart/models/create_cart_model.dart';
...
import 'package:fashion/src/products/widgets/expandable_text.dart';
import 'package:fashion/src/products/widgets/product_bottom_bar.dart';
import 'package:fashion/src/products/widgets/product_colors.dart';
import 'package:fashion/src/products/widgets/product_sizes.dart';
import 'package:fashion/src/products/widgets/similar_products.dart';
              ...
              actions: [
                Padding(
                  ...
                  child: Consumer<WishlistNotifier>(
                    ...
                    print(wishListNotifier.wishList.toString());
          ...
          onTap: () {
            if (accessToken == null) {
              ...
              if (context.read<ColorsSizesNotifier>().colors == '' ||
                ...
                showErrorPopup(context, AppText.kCardErrorText,
                    "Error Adding To Card!", true);
              } else {
